        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{asset('/upload')}}/<?php echo session('Picture') ?>" alt="profile" />
            </a>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{asset('/Manager/Create')}}">+ Create New</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{asset('/Manager/All')}}">ALL Manager</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="/Admin/footer">Footer</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/logout">
              ...
              <span style="color:red; font-style:bold; font-size:16px; padding-left:25px" class="menu-title">Logout</span>
            </a>
          </li>
        </ul>
      </nav>
