            ...
            <form>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    @for($i=0; $i < count($list); $i++) <tr style="text-align: center">
                        ...
                        <td> <a class="btn btn-inverse-warning" href="{{ route('Apartment.Details', [$list[$i]['apartment_ID']]) }}">Details</a></td>
                        <td> <a class="btn btn-inverse-danger" href="{{ route('Apartment.Block', [$list[$i]['apartment_ID']]) }}">Block</a></td>
